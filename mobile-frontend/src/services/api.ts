...
export const authApi = {
  ...
  register: (email: string, password: string, firstName: string, lastName: string) => 
    apiService.post('/api/auth/register', { email, password, firstName, lastName }),
...
export const paymentsApi = {
  ...
  getPayment: (id: string) => 
    apiService.get(`/api/payments/${id}`),
...
export const creditApi = {
  ...
  getLoans: (params?: any) => 
    apiService.get('/api/credit/loans', params),
  
  getLoan: (id: string) => 
    apiService.get(`/api/credit/loans/${id}`),
