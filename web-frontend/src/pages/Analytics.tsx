  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">Comprehensive insights into your financial performance</p>
      </motion.div>
      ...
      >
        <motion.div variants={itemVariants}>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{formatCurrency(data.kpis.totalRevenue)}</div>
              <div className="flex items-center mt-2 text-sm">
                <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
                <span className="text-green-500 font-medium">12.5%</span>
                <span className="text-gray-500 dark:text-gray-400 ml-1">from last {timeframe}</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{formatCurrency(data.kpis.totalProfit)}</div>
              <div className="flex items-center mt-2 text-sm">
                <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
        ...
        <motion.div variants={itemVariants}>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-500 dark:text-gray-400">Profit Margin</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.kpis.profitMargin}%</div>
              <div className="flex items-center mt-2 text-sm">
                <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
        ...
        <motion.div variants={itemVariants}>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Customers</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{data.kpis.activeCustomers}</div>
              <div className="flex items-center mt-2 text-sm">
                <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
        ...
        {chartType === 'customers' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monthly customer growth and retention</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-96">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Legend />
                    <Line type="monotone" dataKey="newCustomers" name="New Customers" stroke="#4F46E5" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                    <Line type="monotone" dataKey="churnedCustomers" name="Churned Customers" stroke="#EF4444" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
        ...
        {chartType === 'metrics' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed financial and customer metrics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">Customer Lifetime Value</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">{formatCurrency(data.kpis.customerLifetimeValue)}</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Average revenue per customer lifetime</div>
                </div>
                
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">Customer Acquisition Cost</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">{formatCurrency(data.kpis.customerAcquisitionCost)}</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Cost to acquire a new customer</div>
                </div>
                
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">Average Revenue Per Customer</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">{formatCurrency(data.kpis.averageRevenuePerCustomer)}</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Average revenue generated per customer</div>
                </div>
                
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">Total Customers</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">{data.kpis.totalCustomers}</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Total number of customers</div>
                </div>
                
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">Churn Rate</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">{data.kpis.churnRate}%</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Percentage of customers lost</div>
                </div>
                
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                  <div className="text-sm text-gray-500 dark:text-gray-400">CLV:CAC Ratio</div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white">
                    {(data.kpis.customerLifetimeValue / data.kpis.customerAcquisitionCost).toFixed(2)}
                  </div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Value generated per acquisition cost</div>
                </div>
              </div>
            </CardContent>
          </Card>
