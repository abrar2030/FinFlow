...
const fetchTransactions = async () => {
  ...
  return Array(87).fill(null).map((_, i) => ({
    id: `TRX-${3000 + i}`,
    description: [
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Revenue vs Expenses</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Monthly comparison of revenue and expenses</p>
            <div className="h-80">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Cash Flow Forecast</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Actual vs projected cash flow for next 6 months</p>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden lg:col-span-2">
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Financial Metrics</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Key performance indicators and financial ratios</p>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">Current Ratio</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.currentRatio.toFixed(2)}</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Liquidity</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">Debt to Equity</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.debtToEquity.toFixed(2)}</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Leverage</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">Profit Margin</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.profitMargin.toFixed(1)}%</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Profitability</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">ROE</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.returnOnEquity.toFixed(1)}%</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Return on Equity</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">Days Receivable</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.daysReceivable}</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Collection Period</div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <div className="text-sm text-gray-500 dark:text-gray-400">Days Payable</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white">{financialMetrics.daysPayable}</div>
                <div className="text-xs text-gray-400 dark:text-gray-500">Payment Period</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Distribution by payment processor</p>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
      ...
      >
        <div className="p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Recent Transactions</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Latest financial activities</p>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {recentTransactions.map((transaction) => (
                  <tr key={transaction.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">{transaction.description}</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{transaction.category}</td>
