...
##                 tax_type=(
##                     TaxType(rule_dict["tax_type"])
##                     if isinstance(rule_dict["tax_type"], str)
##                     else rule_dict["tax_type"]
#                ),
##                 effective_date=rule_dict["effective_date"],
##                 expiration_date=rule_dict["expiration_date"],
##                 rate=Decimal(str(rule_dict["rate"])),
##                 calculation_method=(
##                     CalculationMethod(rule_dict["calculation_method"])
##                     if isinstance(rule_dict["calculation_method"], str)
##                     else rule_dict["calculation_method"]
#                ),
