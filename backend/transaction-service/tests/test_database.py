...
#         with patch("database.create_engine", return_value=self.mock_engine), patch(
#            "database.sessionmaker", return_value=self.mock_session_maker
#        ):
...
#             account_id="account-123", start_date="2025-01-01", end_date="2025-05-31"
#       )
