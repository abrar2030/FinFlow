...
describe('Accounting API Integration Tests', () => {
  ...
  describe('POST /api/accounting/journal-entries', () => {
    test('should create journal entry successfully', async () => {
      ...
      (accountingService.createJournalEntry as jest.Mock).mockResolvedValue(mockResponse);
    ...
    test('should return 400 when ledger entries are not balanced', async () => {
      ...
      (accountingService.createJournalEntry as jest.Mock).mockRejectedValue(error);
  ...
  describe('GET /api/accounting/journal-entries', () => {
    test('should get all journal entries', async () => {
      ...
      (accountingService.getAllJournalEntries as jest.Mock).mockResolvedValue(mockJournalEntries);
  ...
  describe('GET /api/accounting/trial-balance', () => {
    test('should generate trial balance successfully', async () => {
      ...
      (accountingService.generateTrialBalance as jest.Mock).mockResolvedValue(mockTrialBalance);
  ...
  describe('GET /api/accounting/income-statement', () => {
    test('should generate income statement successfully', async () => {
      ...
      (accountingService.generateIncomeStatement as jest.Mock).mockResolvedValue(mockIncomeStatement);

      // Act
      const response = await request(app)
        .get(`/api/accounting/income-statement?startDate=${startDate}&endDate=${endDate}`)
        .set('Authorization', 'Bearer valid_token')
        .expect('Content-Type', /json/)
        .expect(200);
    ...
    test('should return 400 when date parameters are invalid', async () => {
      ...
      // Act
      const response = await request(app)
        .get(`/api/accounting/income-statement?startDate=${invalidStartDate}&endDate=${endDate}`)
        .set('Authorization', 'Bearer valid_token')
        .expect('Content-Type', /json/)
        .expect(400);
  ...
  describe('GET /api/accounting/account/:id/balance', () => {
    test('should get account balance successfully', async () => {
      ...
      const mockBalance = 5000.00;

      (accountingService.getAccountBalance as jest.Mock).mockResolvedValue(mockBalance);

      // Act
      const response = await request(app)
        .get(`/api/accounting/account/${accountId}/balance?asOfDate=${asOfDate}`)
        .set('Authorization', 'Bearer valid_token')
        .expect('Content-Type', /json/)
        .expect(200);
    ...
    test('should return 404 when account not found', async () => {
      ...
      (accountingService.getAccountBalance as jest.Mock).mockRejectedValue(error);

      // Act
      const response = await request(app)
        .get(`/api/accounting/account/${nonExistentAccountId}/balance?asOfDate=${asOfDate}`)
        .set('Authorization', 'Bearer valid_token')
        .expect('Content-Type', /json/)
        .expect(404);
  ...
  describe('GET /api/accounting/financial-metrics', () => {
    test('should calculate financial metrics successfully', async () => {
      ...
      (accountingService.generateIncomeStatement as jest.Mock).mockResolvedValue(mockIncomeStatement);
      (accountingService.generateBalanceSheet as jest.Mock).mockResolvedValue(mockBalanceSheet);
      (analyticsService.calculateFinancialMetrics as jest.Mock).mockResolvedValue(mockFinancialMetrics);

      // Act
      const response = await request(app)
        .get(`/api/accounting/financial-metrics?startDate=${startDate}&endDate=${endDate}`)
        .set('Authorization', 'Bearer valid_token')
        .expect('Content-Type', /json/)
        .expect(200);
