    ...
    <Card>
      <CardContent>
        <form onSubmit={handleSubmit}>
          <Stack spacing={4}>
            <Text fontSize="xl" fontWeight="bold">Make a Payment</Text>
            ...
            <FormControl>
              ...
              <Select value={processorType} onChange={handleProcessorChange}>
                <option value={ProcessorType.STRIPE}>Credit Card (Stripe)</option>
            ...
            {processorType === ProcessorType.STRIPE && (
              <Box id="stripe-card-element" p={4} border="1px solid" borderColor="gray.200" borderRadius="md" />
            )}
            ...
            {processorType === ProcessorType.SQUARE && (
              <Box id="square-card-container" p={4} border="1px solid" borderColor="gray.200" borderRadius="md" />
            )}
